...
> Auto-generated by Cartographer | 2026-01-14 | 720 files | 2.16M tokens
...
115 test files, 537k tokens, 3,791+ tests passing
...
1. **Singleton Pattern**: CryptoEconomyManager, CityAIManager, TitanManager
...
**State:** React Context, localStorage (lz-string compression)
